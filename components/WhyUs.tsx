const reasons = [
  ...
  {
    title: 'Kokenut tiimi',
    description: 'Yli 10 vuoden kokemus rakennusalalta. Tiimimme on koulutettu ja motivoitunut. Tyo tehdaan huolella.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Pystymme aloittamaan nopealla aikataululla. Jatamme tyomaan siistina - ei ylimaaraista sotkua.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Kiintea hinta',
    description: 'Tarjoamme myos urakat kiintealla hinnalla - ei yllatyslaskuja. Tarjous on sitova ja selkea.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Toimistomme on Helsingissa. Paakaupunkiseudun kohteet hoidamme nopeasti ja kustannustehokkaasti.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
